...
- Dynamic minimap zoom matches UITweaks: maximum zoom while stationary, medium zoom while moving or in combat, and minimum zoom while flying. Movement is checked every half-second, with gradual 0.45-second transitions.
